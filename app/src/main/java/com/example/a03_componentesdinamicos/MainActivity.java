...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button botonCrearBarraDeCarga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonCrearBarraDeCarga = findViewById(R.id.botoncrearBarraDeCarga);
        ...
        botonCrearBarraDeCarga.setOnClickListener(this);

    }

    //metodo para la acción del botón
    @Override
    public void onClick(View view) {
        if (view.getId() == R.id.botoncrearBarraDeCarga){
            download(view);
        }
    }
